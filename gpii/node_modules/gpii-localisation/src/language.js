...
gpii.windows.language.getInstalled = function (that) {
    ...
    var knownLanguages = Object.keys(that.model.installedLanguages || {});
    var changed = langCodes.length !== knownLanguages.length;
    if (!changed) {
    ...
    var p;
    if (changed) {
        p = that.getLanguageNames(langCodes).then(function (languages) {
