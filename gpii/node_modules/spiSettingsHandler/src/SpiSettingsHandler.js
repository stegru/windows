...
gpii.windows.spiSettingsHandler.setHighContrastTheme = function (newThemeFile, currentThemeFile, saveAs, dryRun) {
    ...
    if (themeData && themeData.Theme) {
        var windows1809 = semver.gte(os.release(), "10.0.17134");
        ...
        if (windows1809) {
            ...
            if (highContrastId) {
                ...
                var options = {
                    stringId: stringIds[highContrastId - 1],
                    execArgv: []
                };
                ...
                child.on("message", function (hcName) {
                    var displayName = options.stringId && hcName;

                    if (!displayName) {
                        // Use the name of this theme.
