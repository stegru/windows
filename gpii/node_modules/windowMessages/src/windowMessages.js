...
gpii.windows.messages.createMessageWindow = function (that) {
    fluid.log("TEST: " + process.env.GPII_TEST);
    console.log("TEST: " + process.env.GPII_TEST);
    if (!process.env.GPII_TEST) {
        return;
    }
